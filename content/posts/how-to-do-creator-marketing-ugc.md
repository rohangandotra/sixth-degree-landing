---
title: "How to Do Creator Marketing: A UGC Guide for Brands"
...
This guide is about the second one: hiring people to produce content that looks like it came from a real customer, which you then run as ads, put on your product page, or drop into your own feed. If what you actually want is a creator's own audience and endorsement, [How to do influencer marketing: a small business guide](https://sixthdegree.app/blog/how-to-do-influencer-marketing/) covers that instead. The two hires solve different problems, and the brief, the price, and what you walk away owning all change depending on which one you're buying.
...
We're in private beta, opening Fall 2026, so the directory isn't public yet. If you want first access when it opens, join the waitlist below, or email [hello@sixthdegree.app](mailto:hello@sixthdegree.app) with what you're trying to make, and we'll tell you honestly whether UGC or an influencer collab is the better first move.
